...
[![Supported PHP version](https://img.shields.io/static/v1?logo=php&label=PHP&message=8.1-8.3&color=777bb4)](https://packagist.org/packages/magiclegacy/mtgjson-client)
